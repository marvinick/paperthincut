...
ActiveRecord::Schema.define(version: 20150413002440) do
  ...
  add_index "suckers", ["email"], name: "index_suckers_on_email", unique: true, using: :btree
  add_index "suckers", ["reset_password_token"], name: "index_suckers_on_reset_password_token", unique: true, using: :btree
